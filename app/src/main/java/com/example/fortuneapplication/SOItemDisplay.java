...
public class SOItemDisplay extends AppCompatActivity {
    EditText searchbaritems;
    private Spinner spinner5;
    private RecyclerView mRecyclerView;
    private SoItemAdapter mItemAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soitem_display);
        ...
        mItemAdapter = new SoItemAdapter(this, mItemList);
