...
public class SFAdisplayCustomer extends AppCompatActivity {
    RecyclerView sorecyle;
    private SFACustomerAdapter soCustomerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(SFAdisplayCustomer.this,new String[]
                {Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
        locationManager=(LocationManager) getSystemService(Context.LOCATION_SERVICE);
        soCustomerAdapter = new SFACustomerAdapter(SFAdisplayCustomer.this, customers,this,locationManager);
...
//* SEARCH//*
    ...
    public void startThread() {
        stopThread = true;
        stopThread = false;
        SFAdisplayCustomer.ExampleRunnable runnable = new SFAdisplayCustomer.ExampleRunnable(30000);
    ...
    class ExampleRunnable implements Runnable {
        ...
        public void run() {
            ...
            mDatabaseHelper = new PazDatabaseHelper(SFAdisplayCustomer.this);
...
//                            databaseHelper.deleteCustomerData();
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(SFAdisplayCustomer.this);
