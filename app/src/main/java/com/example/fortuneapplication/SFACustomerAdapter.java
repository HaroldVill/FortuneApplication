...
public class SFACustomerAdapter extends RecyclerView.Adapter<SFACustomerAdapter.MyViewHolder> {
    ...
    public SFACustomerAdapter(Context context, ArrayList<Customer> customerList,Activity activity, LocationManager locationManager) {
    ...
    @NonNull
    @Override
    public SFACustomerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.socustomerdesign, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SFACustomerAdapter.MyViewHolder holder, int position) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(Double.parseDouble(longitude2) == 0|| Double.parseDouble(latitude2) == 0){
                            ...
                            Intent tra = new Intent(context, SFAActivity.class);
