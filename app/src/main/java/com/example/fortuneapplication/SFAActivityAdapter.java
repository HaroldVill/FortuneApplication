...
public class SFAActivityAdapter extends RecyclerView.Adapter<SFAActivityAdapter.MyViewHolder> {
    private Context context;
    private final List<Item2> itemList;
    private PazDatabaseHelper database;

    public SFAActivityAdapter(Context context, List<Item2> itemList, PazDatabaseHelper database) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_sfaactivityitemlist, parent, false);
            ...
            public void onClick(View v) {
                ...
                if (position >= 0 && position < itemList.size()) {
                    ...
                    if (database != null) {
                        ...
                        if (context instanceof SFAActivity) {
                            ((SFAActivity) context).updateTotalPayable(updatedTotal);
                        }
                    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView fb1,fb2,fb3,fb4,fb5,delitem,samok,fb21,fb22,fb23;
